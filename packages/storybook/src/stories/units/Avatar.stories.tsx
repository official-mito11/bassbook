...
export const Initials: Story = {
  render: () => (
    <HStack gap={12}>
      <Avatar size="md"><Text>AB</Text></Avatar>
      <Avatar size="md"><Text>CD</Text></Avatar>
      <Avatar size="md"><Text>EF</Text></Avatar>
      <Avatar size="md"><Text>GH</Text></Avatar>
    </HStack>
  ),
};
...
export const AvatarGroup: Story = {
  render: () => (
    <Box>
      <Text fontWeight="medium" mb={8}>Team Members</Text>
      <HStack gap={-8}>
        <Avatar size="md" style={{ border: "2px solid white" }}><Text>JD</Text></Avatar>
        <Avatar size="md" style={{ border: "2px solid white" }}><Text>AS</Text></Avatar>
        <Avatar size="md" style={{ border: "2px solid white" }}><Text>MK</Text></Avatar>
        <Avatar size="md" style={{ border: "2px solid white" }}><Text>LP</Text></Avatar>
        <Box 
          w={32} 
          h={32}
          bg="gray.100" 
    ...
    <VStack gap={16} alignItems="flex-start">
      <HStack gap={12}>
        <Box position="relative">
          <Avatar size="md"><Text>JD</Text></Avatar>
          <Box 
            position="absolute" 
            bottom={0} 
            right={0} 
        ...
        <Box position="relative">
          <Avatar size="md"><Text>AS</Text></Avatar>
          <Box 
            position="absolute" 
            bottom={0} 
            right={0} 
        ...
        <Box position="relative">
          <Avatar size="md"><Text>MK</Text></Avatar>
          <Box 
            position="absolute" 
            bottom={0} 
            right={0} 
        ...
        <Box position="relative">
          <Avatar size="md"><Text>LP</Text></Avatar>
          <Box 
            position="absolute" 
            bottom={0} 
            right={0} 
      ...
      <HStack gap={8}>
        <Badge variant="default" size="sm">Online</Badge>
        <Badge variant="secondary" size="sm">Away</Badge>
        <Badge variant="destructive" size="sm">Busy</Badge>
  ...
  return (
    <HStack gap={12}>
      {users.map((user, index) => (
        ...
        >
          <Avatar size="lg"><Text>{user.initials}</Text></Avatar>
        </Box>
      ))}
    </HStack>
  );
...
export const AvatarWithBadge: Story = {
  render: () => (
    <Box position="relative" display="inline-block">
      <Avatar size="xl"><Text>JD</Text></Avatar>
      <Badge 
        variant="destructive" 
        size="sm"
        position="absolute"
    ...
    <VStack gap={16} alignItems="flex-start">
      ...
      <HStack gap={12} alignItems="flex-end">
        <VStack gap={4}>
          ...
          <Text fontSize="xs" color="gray.500">xs</Text>
        </VStack>
        <VStack gap={4}>
          <Avatar size="sm" hasImage={true}>
            <img src="https://images.unsplash.com/photo-1494790108377-be9c29b29330?w=100&h=100&fit=crop" alt="" />
          </Avatar>
          <Text fontSize="xs" color="gray.500">sm</Text>
        </VStack>
        <VStack gap={4}>
          <Avatar size="md" hasImage={true}>
            <img src="https://images.unsplash.com/photo-1494790108377-be9c29b29330?w=100&h=100&fit=crop" alt="" />
          </Avatar>
          <Text fontSize="xs" color="gray.500">md</Text>
        </VStack>
        <VStack gap={4}>
          <Avatar size="lg" hasImage={true}>
            <img src="https://images.unsplash.com/photo-1494790108377-be9c29b29330?w=100&h=100&fit=crop" alt="" />
          </Avatar>
          <Text fontSize="xs" color="gray.500">lg</Text>
        </VStack>
        <VStack gap={4}>
          <Avatar size="xl" hasImage={true}>
            <img src="https://images.unsplash.com/photo-1494790108377-be9c29b29330?w=100&h=100&fit=crop" alt="" />
          </Avatar>
          <Text fontSize="xs" color="gray.500">xl</Text>
        </VStack>
      </HStack>
    </VStack>
  ),
...
export const CustomStyles: Story = {
  render: () => (
    <VStack gap={16}>
      ...
      <HStack gap={12}>
        <Avatar size="lg" shadow="md"><Text>LP</Text></Avatar>
        <Avatar size="lg" shadow="lg" border="2px solid" borderColor="primary"><Text>TW</Text></Avatar>
        <Avatar size="lg" rounded="none"><Text>RZ</Text></Avatar>
      </HStack>
    </VStack>
  ),
};
