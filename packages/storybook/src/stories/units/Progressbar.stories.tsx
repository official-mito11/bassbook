...
export const Default: Story = {
  render: () => <Progressbar size="md" w={300} />,
};
  ...
  return (
    <VStack gap={16} w={350}>
      <Box w="full">
        ...
        <Progressbar size="md" style={{ "--progress-width": `${progress}%` } as any} />
      </Box>
  ...
  return (
    <VStack gap={16} w={350}>
      <Box w="full">
        ...
        <Progressbar size="lg" style={{ "--progress-width": `${value}%` } as any} />
      ...
      <HStack gap={8} justifyContent="center">
        ...
        <Button variant="ghost" size="sm" onClick={() => setValue(50)}>
          50%
        </Button>
        <Button variant="ghost" size="sm" onClick={() => setValue(100)}>
          Max
        </Button>
      </HStack>
    </VStack>
    ...
    <VStack gap={16} w={350}>
      <Box p={16} border="1px solid" borderColor="gray.200" rounded="lg">
        <VStack gap={12}>
          ...
          <Progressbar size="md" style={{ "--progress-width": `${complete ? 100 : progress}%` } as any} />
      ...
      <Button variant={complete ? "secondary" : "default"} onClick={simulateUpload} disabled={uploading} w="full">
        ...
        <HStack justifyContent="space-between" mb={8}>
          {steps.map((label, index) => (
            <VStack key={label} gap={4} flex={1} alignItems="center">
              <Box w={8} h={8} rounded="full" bg={index < step ? "primary" : index === step ? "primary" : "gray.200"} />
              <Text fontSize="xs" color={index <= step ? "foreground" : "gray.400"} textAlign="center">
                {label}
              </Text>
            </VStack>
          ))}
        </HStack>
        <Progressbar size="sm" style={{ "--progress-width": `${((step - 1) / (steps.length - 1)) * 100}%` } as any} />
      </Box>
  ...
  return (
    <VStack gap={16} w={350}>
      <Box w="full">
        ...
        <Progressbar size="lg" style={{ "--progress-width": `${percentage}%` } as any} />
...
export const ColorVariants: Story = {
  render: () => (
    <VStack gap={16} w={300}>
      <Progressbar size="md" style={{ "--progress-width": "75%", "--progress-bg": "#3b82f6" } as any} />
      <Progressbar size="md" style={{ "--progress-width": "50%", "--progress-bg": "#10b981" } as any} />
      <Progressbar size="md" style={{ "--progress-width": "90%", "--progress-bg": "#f59e0b" } as any} />
      <Progressbar size="md" style={{ "--progress-width": "25%", "--progress-bg": "#ef4444" } as any} />
    </VStack>
  ),
};
